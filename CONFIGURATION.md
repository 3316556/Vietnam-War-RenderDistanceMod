# Configure Render Distance Mod

No MelonPreferences config is required. Numpad Plus increases distance, Numpad Minus decreases, Numpad 0 resets, Numpad Multiply toggles fog, and Numpad Divide adjusts fog distance.
